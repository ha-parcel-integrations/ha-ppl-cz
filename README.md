...
This integration is part of [**ha-parcel-integrations**](https://ha-parcel-integrations.io) — a family of parcel-carrier integrations that all publish the same canonical parcel format, statuses and events.
...
This integration uses the same account API as the mojePPL app, with your own account. It is not affiliated with, endorsed by, or supported by PPL CZ.
