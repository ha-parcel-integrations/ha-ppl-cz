"""Button platform for the PPL CZ parcel tracker integration."""
...
async def async_setup_entry(
    ...
    """Set up the PPL CZ refresh button from a config entry."""
    async_add_entities([PPLCZRefreshButton(entry)])


class PPLCZRefreshButton(ButtonEntity):
    """Button that forces an immediate poll of all tracked PPL CZ parcels."""

    _attr_has_entity_name = True
    _attr_translation_key = "refresh"
    _attr_attribution = ATTRIBUTION

    def __init__(self, entry: PPLCZConfigEntry) -> None:
